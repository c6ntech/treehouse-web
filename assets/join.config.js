...
window.JOIN_CONFIG = {
  ...
  genderRatio: {
    ...
    // ⚠️ 以下三組在 steps 有值時完全不生效，是 steps 設成 null 之後才會用到的後備。
    //    目前設 65/65（＝階梯第一階），所以停用階梯不會讓畫面跳動。
    femaleMin: 65,      // ← 與 femaleMax 相等 = 固定值模式。浮動請用 51
    femaleMax: 65,      // ← 與 femaleMin 相等 = 固定值模式。浮動請用 53
