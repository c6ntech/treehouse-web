...
`femaleMin: 47 / femaleMax: 53`、`changeEverySignups: 5`、`femaleBias: 0.5`。
以出貨的 `policyFemalePct()` 本體跑 n=130~1500 驗證：

| 項目 | 實測 |
|---|---|
| 停留長度 | 剛好 5 人（中位 5、最長 5） |
| 單次最大跳動 | 2% |
| 出現 50/50 | 0 次 |
| 分佈 | 女47:11% 48:11% 49:16% 51:23% 52:19% 53:22% |
| 男性過半的時間 | 37% |
...
|---|---|---|
| 0 | 45% | 25 ／ 100 人 |
| **0.5** | **37%** | **15 ／ 95 人** ← 目前，Morgan 2026-08-21 選定 |
| 1.0 | 21% | 15 ／ 95 人 |
| 1.5 | 13% | 5 ／ 80 人 |
| 2.5 | 6% | 5 ／ 50 人 |
